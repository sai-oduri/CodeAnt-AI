...
const signInItemsSH = [
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="key">
...
const Right = () => {
  ...
  return (
    <div className="bg-[#FAFAFA] h-screen w-full flex flex-col items-center justify-center p-2">
      <div className="w-[388px] lg:w-[662px] rounded-lg border-[1px] bg-white mx-auto">
        <div className="p-6 border-b-[1px]">
          <div className="flex flex-col items-center justify-between gap-5 mb-6">
            <img src={Logo} alt="logo" width={200} />
            <h2 className="text-[#181D27] font-semibold text-3xl">
              Welcome to CodeAnt AI
            </h2>
          </div>
          <div className="bg-[#FAFAFA] text-[#414651] font-medium rounded-md flex border-[1px] ">
            <button
              className={`${selfHosted ? '' : 'bg-[#1570EF] text-white'} rounded-md w-full p-4`}
      ...
      <p className="text-center text-[#181D27] mx-auto mt-6">
